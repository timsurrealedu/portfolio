...
function Inspector({ section, project }: { section: SectionId; project: typeof projects[number] }) {
  ...
  if (section === "about") return <div className="inspect-about"><p className="inspect-label">OPERATOR FINGERPRINT</p><h2>timsurreal</h2><img className="about-portrait" src="/portfolio/about-portrait.png" alt="Professional portrait of Timothy Sebastian Darmawan" /><dl><div><dt>ENVIRONMENT</dt><dd>Linux + Windows</dd></div><div><dt>LANGUAGES</dt><dd>ID / EN / ZH</dd></div><div><dt>REBUILD COUNT</dt><dd>non-zero</dd></div></dl></div>;  return <div className="inspect-contact"><p className="inspect-label">COMMS RELAY</p><h2>channel open</h2><div className="relay-route"><span>JKT</span><b>──▶</b><span>GITHUB</span></div><dl><div><dt>PROTOCOL</dt><dd>human conversation</dd></div><div><dt>TIMEZONE</dt><dd>UTC+7</dd></div><div><dt>RESPONSE</dt><dd>not automated</dd></div></dl><a className="inspect-link" href="https://github.com/timsurrealedu" target="_blank" rel="noreferrer">OPEN CHANNEL →</a></div>;
}
function BootScreen() {
  return (
